...
const BannerContent = ({
    ...
    return (
        <div>
            ...
            {headerText == 'travel well'? <nav className={'breadcrumbs'} aria-label="breadcrumbs"><ol className={'_2jvtI'}><li></li></ol></nav>  : <nav className={'breadcrumbs'} aria-label="breadcrumbs"><ol className={'_2jvtI'}><li><a href="/">Home</a></li> <li>{'>'}</li><li>{headerText}</li></ol></nav>  }
                </Text>
